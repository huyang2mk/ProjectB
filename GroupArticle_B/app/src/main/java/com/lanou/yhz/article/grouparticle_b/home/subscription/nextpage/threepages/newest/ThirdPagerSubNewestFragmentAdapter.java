...
public class ThirdPagerSubNewestFragmentAdapter extends RecyclerView.Adapter<ThirdPagerSubNewestFragmentAdapter.NewestViewHolder> {
    private Context context;
    private  List<SubHottestAdapterBean.DataBean.ResultsBean> data;

    public ThirdPagerSubNewestFragmentAdapter(Context context) {
